...
describe('Crowdsale', () => {
	...
	describe('Deployment', () => {
		...
		it( 'returns the token address', async () => {
			expect( await crowdsale.token()).to.equal(token.address, ether(1))
		})
	})
	...
	describe('Update price', () => {
		  ...
		  describe( 'Failure', () => {
		  			it( 'prevent non-owner from updating the price', async () => {
 ...
 describe('Finalizing Crowdsale', () => {
			...
			describe( 'Success', () => {
				 ...
				 it('emits Finalize even t', async () => {
			...
			describe( 'Failure', async () => {
					 it( 'prevent non-owner from calling finalize', async () => {
